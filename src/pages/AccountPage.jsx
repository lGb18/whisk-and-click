...
export default function AccountPage() {
  ...
  if (isAuthLoading) {
    return <div style={{ padding: "24px" }}>Loading account...</div>;
  }
    ...
    >
      ...
      >
        ...
        <div style={{ display: "grid", gap: "6px" }}>
          <h1 style={{ margin: 0, color: "#333333" }}>Account</h1>
          <div style={{ color: "#666666" }}>
            Review your account details, update your profile, and sign out.
          </div>
        </div>
